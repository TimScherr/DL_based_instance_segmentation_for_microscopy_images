    ...
    for epoch in range(max_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for samples in dataloader[phase]:
                ...
                if configs['label_type'] in ['distance', 'adapted_border']:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    if configs['label_type'] in ['distance', 'adapted_border']:
                        ...
                        if configs['label_type'] == 'adapted_border':
                            # Scale border loss in a way that it is comparable to the cell loss to avoid minimizing
                            # only the border loss
                            loss = 0.7 * loss_border + loss_cell
                        else:
